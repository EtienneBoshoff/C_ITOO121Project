...
public class DPcalcGUIframe extends JFrame {
    public DPcalcGUIframe() throws IOException{
        ...
        assMarkLbl.setBounds(10, 20, 200, 20);          assMarkTxtField.setBounds(250, 200, 200, 20);
        ...
        calcBtn.addActionListener((ActionEvent evt) -> {
            try {
                ...
                if (assignmentMark <= 100.0 && 
                    ...
                    if ((assignmentWeight + semesterTestWeight + continuousAssessmentWeight) <= 1.0 && (assignmentWeight + semesterTestWeight + continuousAssessmentWeight) >= 0.0){
