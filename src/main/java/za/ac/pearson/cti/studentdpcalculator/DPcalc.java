...
public class DPcalc {
    ...
    private final String stdDVnumber;
     ...
     * @param assignmentMark The assignment mark of the student in percentage
     * @param semesterTestMark The semester test mark of the student in percentage
     * @param continuousAssessmentMark The continual assessment mark of the student in percentage
     */
    public DPcalc(Double semesterTestMark,Double assignmentMark, Double continuousAssessmentMark) {
       this.subject.add(new Subject("DP", semesterTestMark, assignmentMark,continuousAssessmentMark, 0.2, 0.2, 0.6));
        stdName = "Default Student";
        stdDVnumber = "N/A";
    }
    ...
    public DPcalc(Double assignment, Double semesterTest, Double continuous, String studentName, String studentDVnumber, String subject, Double assignmentWeight, Double semesterTestWeight, Double continousAssessmentWeight) {
        ...
        this.stdDVnumber = studentDVnumber;
    }
    ...
    public Double getAssignmentWeight(){
        return this.subject.get(0).getAssignmentWeight();
    }
    ...
    public Double getSemesterTestMark(String subject) {
        return this.subject.get(getSubject(subject)).getSemesterTest();
    }
    
    public Double getAssignmentMark(String subject) {
        return this.subject.get(getSubject(subject)).getAssignmentMark();
    }
    
    public Double getContinuousAssessmentMark(String subject) {
        return this.subject.get(getSubject(subject)).getContinuousMark();
    }
    ...
    public Boolean verifyDVnum() {
        if (stdDVnumber.length() == 11){ 
            String d = stdDVnumber.substring(0)+"";
            String v = stdDVnumber.substring(1)+"";
            String year = stdDVnumber.substring(2, 6);
            String dash = stdDVnumber.charAt(6)+"";
            String lastNum = stdDVnumber.substring(7);
