...
public class Subject {
    ...
    public void setSemesterTestMark(Double semesterTestMark, String name) {
        this.semesterTestMark = semesterTestMark;
    }
    ...
    public void setContinuousAssessmentMark(Double continuousAssessmentMark, String name) {
        this.continuousAssessmentMark = continuousAssessmentMark;
    }
    ...
    public void setSemesterTestWeight(Double semesterTestWeight, String name) {
        this.semesterTestWeight = semesterTestWeight;
    }
    ...
    public void setContinuousAssessmentWeight(Double continuousAssessmentWeight, String name) {
        this.continuousAssessmentWeight = continuousAssessmentWeight;
    }
    ...
    public void setAssessmentWeight(Double assessmentWeight, String name) {
        this.assessmentWeight = assessmentWeight;
    }
